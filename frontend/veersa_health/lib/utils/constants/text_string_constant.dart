class TextStringsConstants {
  ...
  static const String onBoardingTitle1 = "Find  the Best Doctors Near You.";
  static const String onBoardingTitle2 = "Book Appointments Instantly";
  static const String onBoardingTitle3 = "Smart Reminders & Easy Directions";

  static const String onBoardingSubTitle1 =
      "Discover trusted doctors based on specialty and location, all in one place. ";
  static const String onBoardingSubTitle2 =
      "Choose a convenient time slot and confirm your appointment in just a few taps.";
  static const String onBoardingSubTitle3 =
      "Get timely appointment reminders and the fastest route to your doctor’s clinic, all in one place.";
  //Home
